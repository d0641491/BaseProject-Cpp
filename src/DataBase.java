 ...
 * 
 * Written at 21/12/2018, 
 */

public class DataBase<T>//I'm New to Java, and I'm not very familiar with <T>.
{
	public class Food
	{
		int Max_Price;
	 ...
	 * } 
	 */
	public void add(T element, int Type, Questions Ans, int Order_Number)
	{
